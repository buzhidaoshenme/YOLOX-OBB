...
def mergebase_parallel(srcpath, dstpath, nms):
    """
        ��Դ·�������е�txtĿ����Ϣ,��nms�����Ŀ��·���е�ͬ��txt
        @param srcpath: �ϲ�ǰ��Ϣ�����txtԴ·��
        @param dstpath: �ϲ�����Ϣ�����txtĿ��·��
        @param nms: NMS����
    """
    pool = Pool(4)
...
def mergebypoly(srcpath, dstpath):
    """
        srcpath: result files before merge and nms.txt����Ϣ��ʽΪ:[P0770__1__0___0 confidence poly]
        dstpath: result files after merge and nms.�����txt��Ϣ��ʽΪ:[P0770 confidence poly]
    """
    # srcpath = r'/home/lyy/gxw/DOTA_OBB_1_5/results'
    # dstpath = r'/home/lyy/gxw/merge_result'
...
if __name__ == '__main__':
    mergebypoly(r'/home/lyy/gxw/DOTA_OBB_1_5/results', r'/home/lyy/gxw/result/txt')
